...
/* ===================== 1. FOUNDATIONS ===================== */
{
  ...
  ladder:[
    ...
    {name:"Full push-up", target:"Chest to the floor — <b>10–12</b> reps", level:"foundation", lv:5,
    ...
    {name:"Diamond / close push-up", target:"Hands together under the sternum — <b>8–10</b>", level:"intermediate", lv:6,
    ...
    {name:"Archer push-up", target:"<b>5–6</b> per side, opposite arm nearly straight", level:"intermediate", lv:7,
    ...
    {name:"Pseudo-planche push-up", target:"Hands at the hips, shoulders past the wrists — <b>8</b>", level:"advanced", lv:8,
    ...
    {name:"One-arm push-up", target:"Feet no wider than shoulders, chest to floor", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Scapular pull-up", target:"<b>8–10</b> — arms straight, shoulders pull down from the ears", level:"foundation", lv:3,
    ...
    {name:"Assisted pull-up or negative", target:"Band, foot on box, or <b>5 × 5s</b> lowering", level:"foundation", lv:4,
    ...
    {name:"Full pull-up", target:"<b>5</b> strict — chin over bar, dead hang each rep", level:"intermediate", lv:6,
    ...
    {name:"Chest-to-bar pull-up", target:"<b>8</b> with the chest touching the bar", level:"intermediate", lv:7,
    ...
    {name:"Weighted pull-up", target:"<b>+25%</b> bodyweight for <b>5</b>", level:"advanced", lv:8,
    ...
    {name:"Archer / assisted one-arm", target:"Load one side heavily — the doorway to the one-arm track", level:"elite", lv:9,
...
},
{
  ...
  ladder:[
    {name:"High bar row", target:"Bar at hip height, body steep — <b>15</b> reps", level:"foundation", lv:3,
    ...
    {name:"Horizontal row", target:"Body parallel to the floor, heels down — <b>12</b>", level:"foundation", lv:4,
    ...
    {name:"Feet-elevated row", target:"Feet on a box, body level or head lower — <b>10</b>", level:"intermediate", lv:5,
    ...
    {name:"Archer row", target:"<b>6</b> per side", level:"advanced", lv:7,
    ...
    {name:"One-arm row / front lever row", target:"One arm horizontal, or rows held in tuck front lever", level:"elite", lv:9,
...
},
{
  ...
  ladder:[
    {name:"Support hold", target:"Arms locked, shoulders down — hold <b>30s</b>", level:"foundation", lv:4,
    ...
    {name:"Bench or box dip", target:"<b>12</b> with feet on the floor", level:"foundation", lv:4,
    ...
    {name:"Negative dip", target:"<b>5 × 5s</b> lowering to 90°", level:"foundation", lv:4,
    ...
    {name:"Parallel bar dip", target:"<b>8–10</b> full depth", level:"intermediate", lv:6,
    ...
    {name:"Ring dip", target:"<b>6–8</b> with rings turned out at the top", level:"advanced", lv:8,
    ...
    {name:"Weighted dip", target:"<b>+25%</b> bodyweight for <b>5</b>", level:"advanced", lv:8,
...
},
{
  ...
  ladder:[
    ...
    {name:"Active hang", target:"Shoulders pulled down and back — <b>20–30s</b>", level:"foundation", lv:4,
    ...
    {name:"Hanging with movement", target:"Side-to-side swings, single-arm hand release, <b>15s</b> holds", level:"intermediate", lv:6,
    ...
    {name:"Skin the cat", target:"Slow roll through to German hang and back — <b>3–5</b>", level:"intermediate", lv:6,
    ...
    {name:"Towel or fingertip hang", target:"<b>20s</b> on a towel, or one-arm hang <b>10s</b> per side", level:"advanced", lv:8,
...
},
{
  ...
  ladder:[
    ...
    {name:"Hanging leg raise", target:"<b>8–10</b> with straight legs to horizontal", level:"intermediate", lv:6,
    ...
    {name:"Toes to bar", target:"<b>5–8</b> strict, no swing", level:"advanced", lv:8,
    ...
    {name:"Dragon flag", target:"Negatives first, then <b>5</b> full reps", level:"elite", lv:9,
...
/* ===================== KINETIC CHAIN & PREP =====================
   The line that everything overhead is built on. Not tricks — the
   proprioception and positions the tricks stand on. Referenced from
   Handstand, Planche and the levers. */
{
  group:"Foundations", name:"Kinetic Chain &amp; Prep", cat:"LINE", tag:"The line the tricks stand on — wrist to shoulder to ribs to hips, and the body-awareness that ties them together",
  ladder:[
    {name:"Wrist prep sequence", target:"Load the wrists in every direction before anything goes on the hands — <b>1–2 min</b>", level:"foundation", lv:1,
    ...
    {name:"Hollow-body hold", target:"Lower back pressed flat, ribs down — hold <b>30s</b>", level:"foundation", lv:4,
     ...
     faults:["Lower back arching off the floor","Holding the breath to hold the shape"]},
    {name:"Hollow-to-arch (banana) transitions", target:"Swap slowly between hollow and a gentle arch — <b>8</b> controlled", level:"foundation", lv:4,
     primary:["Rectus abdominis","Erector spinae"], secondary:["Glutes","Serratus anterior"],
     cues:["Two shapes, swapped under control: hollow (ribs in, the strong line) and banana (ribs flared, the leak).","Feeling the difference is the point. In a handstand you are always chasing the hollow and fighting the banana."],
     faults:["Rushing so the shapes blur together","Only moving the legs while the ribs stay flared"]},
    {name:"Posterior pelvic tilt drill", target:"Tuck the pelvis under and hold the tuck against the wall — <b>20s</b>", level:"foundation", lv:4,
    ...
    {name:"Prone shoulder raise", target:"Face down, arms overhead, lift the hands keeping elbows straight — <b>3 × 10</b>", level:"intermediate", lv:5,
     ...
     faults:["Bending the elbows to cheat the lift","Shrugging without the shoulder blades actually moving"]},
    {name:"Pike scapular push-up", target:"Pike position, push the floor away and let the shoulder blades spread — <b>3 × 8</b>", level:"intermediate", lv:5,
     primary:["Serratus anterior","Anterior deltoid"], secondary:["Trapezius (upper)","Triceps"],
     cues:["Hips high in a pike, arms locked. Move only the shoulder blades: sink between them, then push tall and spread them.","This teaches protraction — pushing the floor away — which is what a strong handstand and a planche are made of."],
     faults:["Bending the elbows so it becomes a pike push-up","Only moving a couple of centimetres"]},
    {name:"Active-shoulder wall shrug", target:"Chest-to-wall handstand, shrug the shoulders to the ears — <b>3 × 8</b>", level:"advanced", lv:7,
     primary:["Trapezius (upper)","Serratus anterior","Deltoids"], secondary:["Core","Wrist flexors"],
     cues:["In a chest-to-wall handstand, push the floor away and lift the whole body a few centimetres by shrugging.","Now the active shoulder happens under full bodyweight, upside down. This is the last link in the chain."],
     faults:["Bending the elbows","Letting the ribs flare and the back arch under load"]},
    {name:"Full integration: chest-to-wall line", target:"Every link at once, held clean — <b>60s</b>", level:"advanced", lv:7,
     primary:["Deltoids","Serratus anterior","Rectus abdominis"], secondary:["Trapezius (upper)","Glutes","Wrist flexors"],
     cues:["Wrists loaded, shoulders active and pushing, ribs down, pelvis tucked, glutes and legs squeezed. All of it, breathing calmly.","When a one-minute chest-to-wall hold feels like all these things at once instead of a fight, the chain is built and balance can start."],
     faults:["Holding the breath","One link always slipping — usually the ribs or the shoulders"]}
  ],
  advanced:["Freestanding hollow holds","Handstand line drills off the wall","Straddle press shapes"],
  support:["Chaturanga","Upward dog / cobra","Cat-cow for rib control","Dead bug","Wall walk-ups","Breathing while inverted — calm, rhythmic, never held"]
},
...
/* ===================== 2. LOWER BODY ===================== */
{
  ...
  ladder:[
    ...
    {name:"Split squat", target:"<b>12</b> per leg, back knee to the floor", level:"foundation", lv:3,
    ...
    {name:"Bulgarian split squat", target:"<b>10</b> per leg, rear foot elevated", level:"intermediate", lv:4,
    ...
    {name:"Box pistol / assisted pistol", target:"<b>8</b> per leg to a low box", level:"intermediate", lv:5,
    ...
    {name:"Jump squat / explosive work", target:"<b>3 × 8</b> soft landings", level:"advanced", lv:7,
...
},
{
  ...
  ladder:[
    {name:"Glute bridge", target:"<b>15</b> with a two-second squeeze at the top", level:"foundation", lv:3,
    ...
    {name:"Single-leg glute bridge", target:"<b>12</b> per side", level:"foundation", lv:4,
    ...
    {name:"Nordic curl negative", target:"<b>5 × 4s</b> lowering with assistance", level:"intermediate", lv:6,
    ...
    {name:"Slider or ring leg curl", target:"<b>10</b> with hips lifted", level:"intermediate", lv:6,
    ...
    {name:"Full Nordic curl", target:"<b>3–5</b> controlled all the way down and back", level:"elite", lv:9,
...
},
{
  ...
  ladder:[
    {name:"Assisted pistol", target:"Hold a support or counterbalance a plate", level:"foundation", lv:4,
    ...
    {name:"Box pistol", target:"Sit to a box and stand up on one leg", level:"foundation", lv:5,
    ...
    {name:"Full pistol", target:"Full depth, controlled, no support", level:"intermediate", lv:6,
    ...
    {name:"Weighted or elevated pistol", target:"Add load, or drop the heel below the step", level:"advanced", lv:8,
    ...
    {name:"Shrimp squat", target:"Rear foot held behind, knee to floor", level:"advanced", lv:8,
...
/* ============ 3. BALANCE &amp; STRAIGHT-ARM SKILLS ============ */
{
  ...
  ladder:[
    {name:"Frog stand", target:"Knees on the elbows, feet off the floor — <b>20s</b>", level:"foundation", lv:3,
    ...
    {name:"Crow pose (straight-ish arms)", target:"Knees higher on the arms — <b>30s</b>", level:"foundation", lv:4,
    ...
    {name:"Tuck elbow lever", target:"Elbows in the hip crease, knees tucked — <b>15s</b>", level:"intermediate", lv:5,
    ...
    {name:"Straddle elbow lever", target:"Legs wide and straight — <b>10–15s</b>", level:"intermediate", lv:6,
    ...
    {name:"Full elbow lever", target:"Legs together, body one line — <b>10s+</b>", level:"advanced", lv:7,
...
},
{
  ...
  ladder:[
    ...
    {name:"One-arm handstand", target:"A full track of its own — see the next card once your two-arm hold is solid", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Bulletproof freestanding handstand", target:"Effortless <b>60s</b> before you start shifting", level:"foundation", lv:7,
    ...
    {name:"Weight shifts and taps", target:"Load one arm fully, tap the other hand off the floor", level:"intermediate", lv:8,
    ...
    {name:"Assisted one-arm", target:"Free hand on a low block, wall or fingertips", level:"advanced", lv:9,
    ...
    {name:"Two-finger / staggered support", target:"Barely-there support from the free hand", level:"advanced", lv:9,
    ...
    {name:"One-arm handstand", target:"Unassisted — build <b>2s → 5s → 10s</b>", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Pike push-up", target:"<b>10+</b> with hips high, head toward the floor", level:"foundation", lv:5,
    ...
    {name:"Elevated pike push-up", target:"Feet on a box — <b>8+</b> reps, deeper range", level:"foundation", lv:6,
    ...
    {name:"Freestanding handstand push-up", target:"Balance and press with no wall", level:"advanced", lv:9,
    ...
    {name:"Deficit or 90° press", target:"Extra range on parallettes, or the 90-degree push-up", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Planche lean", target:"Shoulders well past the wrists, scapula protracted — hold <b>30s</b>", level:"foundation", lv:4,
    ...
    {name:"Tuck planche", target:"Knees to chest, hips at shoulder height — hold <b>15–20s</b>", level:"foundation", lv:6,
    ...
    {name:"Advanced tuck planche", target:"Hips open, flat back, knees still tucked — hold <b>15s</b>", level:"intermediate", lv:7,
    ...
    {name:"Straddle planche", target:"Legs wide and straight — hold <b>5–10s</b>", level:"advanced", lv:9,
    ...
    {name:"Full planche", target:"Legs together, body one line — hold <b>5s+</b>", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Tuck front lever", target:"Knees tucked, back parallel to the floor — hold <b>20s</b>", level:"foundation", lv:6,
    ...
    {name:"Advanced tuck front lever", target:"Flat back, hips open, knees in — hold <b>15–20s</b>", level:"intermediate", lv:7,
    ...
    {name:"One-leg front lever", target:"One leg extended, one tucked — hold <b>10–15s</b> per side", level:"intermediate", lv:7,
    ...
    {name:"Straddle front lever", target:"Both legs straight and wide — hold <b>10s</b>", level:"advanced", lv:8,
    ...
    {name:"Full front lever", target:"Legs together, body flat — hold <b>5s+</b>", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"German hang", target:"Comfortable shoulder-extension hang — <b>30s</b> relaxed", level:"foundation", lv:5,
    ...
    {name:"Tuck back lever", target:"Rolled through to a face-down tuck — hold <b>20s</b>", level:"foundation", lv:6,
    ...
    {name:"Advanced tuck back lever", target:"Hips open, knees tucked — hold <b>15s</b>", level:"intermediate", lv:7,
    ...
    {name:"Straddle back lever", target:"Legs straight and wide — hold <b>10s</b>", level:"advanced", lv:8,
    ...
    {name:"Full back lever", target:"Legs together, body flat — hold <b>5s+</b>", level:"elite", lv:9,
...
},
{
  ...
  ladder:[
    {name:"Clutch flag", target:"Pole in the elbow crease, body sideways — hold <b>10s</b>", level:"foundation", lv:5,
    ...
    {name:"Support setup and vertical flag", target:"Grip locked, hips up, feet toward the sky", level:"foundation", lv:6,
    ...
    {name:"Tuck flag", target:"Body sideways, knees tucked — hold and control", level:"intermediate", lv:7,
    ...
    {name:"One-leg flag", target:"Lower from vertical with one leg extended", level:"intermediate", lv:7,
    ...
    {name:"Straddle flag", target:"Legs wide and straight, body horizontal — hold <b>5–10s</b>", level:"advanced", lv:8,
    ...
    {name:"Full flag", target:"Legs together, body one clean line", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Support hold with tuck", target:"Straight arms, shoulders depressed, knees tucked — <b>20s</b>", level:"foundation", lv:4,
    ...
    {name:"One-leg L-sit", target:"One leg straight, one tucked — <b>15s</b> per side", level:"foundation", lv:5,
    ...
    {name:"L-sit", target:"Legs straight, parallel to the floor — hold <b>15–30s</b>", level:"intermediate", lv:6,
    ...
    {name:"V-sit", target:"Legs raised above parallel", level:"advanced", lv:8,
    ...
    {name:"Manna", target:"Hips behind the hands, legs toward the face", level:"elite", lv:10,
...
/* ============ 4. DYNAMIC, BARS &amp; RINGS ============ */
{
  ...
  ladder:[
    {name:"Passive swing", target:"Small relaxed swing, controlled stop — <b>10</b> swings", level:"foundation", lv:3,
    ...
    {name:"Tap swing (active swing)", target:"Hollow to arch and back, shoulders driving — <b>8</b>", level:"foundation", lv:4,
    ...
    {name:"Kip / knee raise swing", target:"Knees drive up at the front of the swing — <b>6</b>", level:"intermediate", lv:6,
    ...
    {name:"Hip pullover", target:"Roll over the bar into support from a hang", level:"intermediate", lv:6,
    ...
    {name:"Back hip circle", target:"From support, circle backward around the bar and finish in support", level:"advanced", lv:7,
    ...
    {name:"Controlled dismount", target:"Swing, release at the front, land balanced", level:"advanced", lv:7,
...
},
{
  ...
  ladder:[
    {name:"Strict chest-to-bar pull-up", target:"<b>8–10</b> clean, chest touching the bar", level:"foundation", lv:7,
    ...
    {name:"Straight-bar dip", target:"<b>8–10</b> full-depth dips over the bar", level:"foundation", lv:7,
    ...
    {name:"Explosive high pull", target:"Pull the bar to the sternum or lower ribs", level:"intermediate", lv:7,
    ...
    {name:"Transition drills", target:"Band-assisted reps plus slow negatives through the sticking point", level:"intermediate", lv:8,
    ...
    {name:"Strict bar muscle-up", target:"No kip, controlled turnover", level:"advanced", lv:8,
...
},
{
  ...
  ladder:[
    {name:"False-grip hang and pull", target:"Hold the false grip, then pull-ups keeping it — <b>5+</b>", level:"foundation", lv:7,
    ...
    {name:"Ring dips with turnout", target:"<b>8–10</b> full depth, rings turned out at the top", level:"foundation", lv:8,
    ...
    {name:"Explosive false-grip pull", target:"Pull the rings down to sternum height", level:"intermediate", lv:8,
     primary:["Latissimus dorsi","Biceps","Lower trapezius"], secondary:["Rear deltoid","Core","Grip"],
    ...
    {name:"Transition work", target:"Band-assisted plus slow negatives through the catch", level:"intermediate", lv:8,
    ...
    {name:"Strict ring muscle-up", target:"No swing, controlled turnover into support", level:"advanced", lv:9,
...
},
{
  ...
  ladder:[
    {name:"Ice cream maker", target:"From an inverted hang, roll out to a front lever position and back — <b>5</b>", level:"intermediate", lv:7,
    ...
    {name:"Kipping muscle-up", target:"Swing, kip, transition — <b>3</b> clean reps", level:"intermediate", lv:7,
    ...
    {name:"360 bar spin", target:"Full rotation around the bar, released and re-caught", level:"advanced", lv:9,
    ...
    {name:"Shrimp flip / bar flip", target:"Flip over the bar and catch in support or hang", level:"advanced", lv:9,
    ...
    {name:"Hefesto (reverse muscle-up)", target:"From a back lever position, pull up into support behind the bar", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Ring support hold", target:"Arms locked, rings turned out — <b>30s</b>", level:"foundation", lv:5,
    ...
    {name:"Ring row and ring push-up", target:"<b>12</b> rows, <b>10</b> push-ups with turnout at lockout", level:"foundation", lv:5,
    ...
    {name:"Ring dip and ring L-sit", target:"<b>8</b> dips with turnout; L-sit <b>15s</b>", level:"intermediate", lv:7,
    ...
    {name:"Ring back lever and skin the cat", target:"Tuck back lever on rings — <b>15s</b>", level:"advanced", lv:8,
    ...
    {name:"Iron cross progressions", target:"Band-assisted cross holds, then partial ranges", level:"elite", lv:10,
...
},
{
  ...
  ladder:[
    {name:"Heavy weighted pull-ups", target:"<b>+50%</b> bodyweight or more for reps", level:"foundation", lv:8,
    ...
    {name:"Archer pull-ups", target:"Load one side, other arm nearly straight — <b>5</b> per side", level:"intermediate", lv:8,
    ...
    {name:"Assisted one-arm", target:"Towel, band or finger assist on the free hand", level:"intermediate", lv:9,
    ...
    {name:"One-arm negatives", target:"Slow, controlled lowering — <b>5 × 5s</b>", level:"advanced", lv:9,
    ...
    {name:"One-arm pull-up", target:"Full range, one arm, no assist", level:"elite", lv:10,
...
"Kinetic Chain &amp; Prep|Wrist prep sequence":{m:"pike",do:[
 "On your knees, hands flat on the floor. Rock forward and back over the wrists, fingers pointing forward, then backward, then to the sides.",
 "Add fingertip pushes and the backs of the hands, easing into each direction.",
 "One to two minutes, always before anything else goes on the hands."]},
"Kinetic Chain &amp; Prep|Hollow-body hold":{m:"dragonflag",do:[
 "Lie on your back and press the lower back flat into the floor.",
 "Lift the shoulders and legs just off the ground, arms overhead or by your sides.",
 "Hold while breathing. If the back lifts, bend the knees or raise the legs higher."]},
"Kinetic Chain &amp; Prep|Hollow-to-arch (banana) transitions":{m:"dragonflag",do:[
 "Start in a hollow: ribs down, lower back flat, arms and legs off the floor.",
 "Roll slowly to a gentle arch — chest and thighs lift, belly toward the floor.",
 "Swap back and forth under full control. Feel which one is strong and which one leaks."]},
"Kinetic Chain &amp; Prep|Posterior pelvic tilt drill":{m:"bridge",do:[
 "Stand with your back against a wall, feet a little forward.",
 "Flatten your lower back into the wall by tucking your tailbone under and drawing the ribs down.",
 "Hold the tuck, then raise the arms overhead without letting the back arch off the wall."]},
"Kinetic Chain &amp; Prep|Prone shoulder raise":{m:"dragonflag",do:[
 "Lie face down, arms straight overhead in a Y, thumbs up.",
 "Lift the arms and chest off the floor, driving the shoulders up toward your ears with the elbows locked.",
 "Lower slowly. Three sets of ten. This is your every-week shoulder builder."]},
"Kinetic Chain &amp; Prep|Pike scapular push-up":{m:"pike",do:[
 "Set up in a pike: hips high, arms locked, head between the arms.",
 "Without bending the elbows, let the shoulder blades sink together, then push the floor away and spread them wide.",
 "Slow and full range. Three sets of eight."]},
"Kinetic Chain &amp; Prep|Active-shoulder wall shrug":{m:"handstand",do:[
 "Get into a chest-to-wall handstand, arms locked, belly toward the wall.",
 "Push the floor away and lift your whole body a few centimetres by shrugging the shoulders to the ears.",
 "Lower under control, elbows straight throughout. Three sets of eight."]},
...
"Kinetic Chain &amp; Prep|Hollow-body hold": EX("Hollow, ribs down", FLOOR, hold(
  [50,116, 70,118, 54,108, 40,100, 108,124, 140,116, 168,110])),
"Kinetic Chain &amp; Prep|Hollow-to-arch (banana) transitions": EX("Hollow to arch", FLOOR, reps(
  [50,116, 70,118, 54,108, 40,100, 108,124, 140,116, 168,110],
  [52,126, 72,124, 56,132, 42,138, 110,120, 142,124, 170,118])),
"Kinetic Chain &amp; Prep|Posterior pelvic tilt drill": EX("Pelvis tucked to the wall", FLOOR + '<line class="prop" x1="40" y1="10" x2="40" y2="134"/>', reps(
  [64,30, 60,44, 52,58, 46,70, 62,84, 60,108, 58,132],
  [58,30, 56,44, 70,42, 82,40, 58,86, 58,109, 58,132])),
"Kinetic Chain &amp; Prep|Prone shoulder raise": EX("Face down, arms lift", FLOOR, reps(
  [58,124, 76,126, 100,127, 124,128, 116,127, 148,128, 178,129],
  [58,120, 76,120, 102,114, 128,108, 116,124, 148,126, 178,128])),
"Kinetic Chain &amp; Prep|Pike scapular push-up": EX("Pike, blades spread", FLOOR, reps(
  [150,104, 138,100, 144,114, 150,126, 100,58, 80,96, 62,130],
  [150,110, 138,106, 146,116, 150,126, 100,64, 80,98, 62,130])),
"Kinetic Chain &amp; Prep|Active-shoulder wall shrug": EX("Wall, shrug up", FLOOR + WALL_R, reps(
  [144,120, 150,108, 150,120, 150,132, 152,74, 154,48, 156,22],
  [144,114, 150,102, 150,114, 150,126, 152,68, 154,42, 156,16])),
"Kinetic Chain &amp; Prep|Wrist prep sequence": EX("Wrist prep", FLOOR, reps(
  [150,104, 138,100, 144,114, 150,126, 100,58, 80,96, 62,130],
